...
<section>
    <div class="teacher_movie-form">
        <div class="container mt-5">
            ...
            <h5 class="text-center my-2 teacher_movie-form-title">تمرین های دانش آموز : <?= $list_student[0]['student_lastname'] . ' ' . $list_student[0]['student_lastname'] ?></h5>
            <?php
            $message = flash('assignment');
            if (!empty($message)) {
            ?>

                <div class="text-center mx-5 my-2 alert alert-danger">
            ...
            <div class="row position-relative">
                ...
                <div class="pill_table-responsive">
                    <table class="table pill_table-custom table-striped">
                        <thead>
                            <tr>
                                <th class="text-center">عنوان تمرین</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td class="text-center"><?= $list['assignment_title'] ?></td>
                                    ...
                                    <td class="text-center">
                                        <form action="<?= url('teacher/record_studentList_assignment') ?>" method="post" class="d-flex justify-content-center">
                                            <div class=" ms-2">
                                                <select name="score" id="" class="form-control">
                                                    <option value="NULL">نمره را ثبت کنید</option>
